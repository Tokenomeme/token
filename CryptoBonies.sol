...
interface IERC20 {
 ...
 //   function mintToken(address account, uint256 amount) OnlyOwner;
...
contract CryptoBonies  is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 132670764300000000000000000000; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CryptoBonies";
