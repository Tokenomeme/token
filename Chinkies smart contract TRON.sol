...
library Address {
    ...
    function functionCallWithValue(
        ...
        require(isContract2(target), "Address: call to non-contract");
    ...
    function functionStaticCall(
        ...
        require(isContract2(target), "Address: static call to non-contract");
    ...
    function functionDelegateCall(
        ...
        require(isContract2(target), "Address: delegate call to non-contract");
...
contract ChinkiesTron is ERC721, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public maxSupplyPerRound = 360;

    //TODO:modify price for tron
    ...
    uint256 freemintAmountLimit = 12;
    ...
    function freeMint(
        ...
        require(msg.sender == account, "TokenomemeNFT: Not allowed");
        require(freeM, "TokenomemeNFT: Freemint is OFF");
        require(!paused, "TokenomemeNFT: Contract is paused");
        require(
            _amount <= freemintAmountLimit,
            "TokenomemeNFT: You can't mint so much tokens"
        );
        require(
            _freemintClaimed[msg.sender] + _amount <= freemintAmountLimit,
            "TokenomemeNFT: You can't mint so much tokens"
        );
        ...
        require(
            ...
            "TokenomemeNFT: max supply exceeded"
        );
        require(
            _price * _amount <= msg.value,
            "TokenomemeNFT: Not enough ethers sent"
        );
    ...
    function presaleMint(
        ...
        require(msg.sender == account, "TokenomemeNFT: Not allowed");
        require(presaleM, "TokenomemeNFT: Presale is OFF");
        require(!paused, "TokenomemeNFT: Contract is paused");
        require(
    ...
    function publicSaleMint(uint256 _amount) external payable onlyAccounts {
        require(publicM, "TokenomemeNFT: PublicSale is OFF");
        require(!paused, "TokenomemeNFT: Contract is paused");
        require(_amount > 0, "TokenomemeNFT: zero amount");
